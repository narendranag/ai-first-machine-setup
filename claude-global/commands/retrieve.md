...
1. Search the index: `~/system-manager/bin/archive-pull --search "<term>"`, trying a few terms (names, years, extensions). If `INDEX.md` looks stale, `archive-pull --reindex` first.
